...
#import "BDIMDebugWeakProxy.h"

@implementation BDIMDebugFPSLabel{
    CADisplayLink *_link;
    NSUInteger _count;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    _link = [CADisplayLink displayLinkWithTarget:[BDIMDebugWeakProxy proxyWithTarget:self] selector:@selector(tick:)];
