...
public class VEMessageEditCommonActivity extends Activity {
    ...
    public static void startForResult(Activity activity, String title, String initText, int limit, int requestCode) {
        Intent intent = new Intent(activity, VEMessageEditCommonActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ve_im_msg_activity_edit_group_name);
