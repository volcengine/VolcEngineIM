package com.bytedance.im.app.detail.ext;
...
public class VEDebugExtActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.local_ext).setOnClickListener(v -> VEEditCommonActivity.startForResult(VEDebugExtActivity.this, "本地字段", localStr, Integer.MAX_VALUE, REQUEST_CODE_EDIT_EXT_LOCAL));
        findViewById(R.id.conv_ext).setOnClickListener(v -> VEEditCommonActivity.startForResult(VEDebugExtActivity.this, "公共字段", convStr, Integer.MAX_VALUE, REQUEST_CODE_EDIT_EXT_CORE));
        findViewById(R.id.my_ext).setOnClickListener(v -> VEEditCommonActivity.startForResult(VEDebugExtActivity.this, "私有字段", myStr, Integer.MAX_VALUE, REQUEST_CODE_EDIT_EXT_MY));
    ...
    private void updateByConversation(BIMConversation conversation){
        localStr = VEUtils.mapToString(conversation.getLocalExt());
        convStr = VEUtils.mapToString(conversation.getCoreExt());
        myStr = VEUtils.mapToString(conversation.getMyExt());
    }
