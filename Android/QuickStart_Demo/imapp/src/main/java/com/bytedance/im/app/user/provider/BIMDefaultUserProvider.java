package com.bytedance.im.app.user.provider;
...
public class BIMDefaultUserProvider implements BIMUserProvider {
    ...
    BIMFriendListener friendListener = new BIMFriendListener() {
        @Override
    ...
    public void addUserUpdateListener(OnUserInfoUpdateListener listener) {
        BIMClient.getInstance().getService(BIMContactExpandService.class).addFriendListener(friendListener);
