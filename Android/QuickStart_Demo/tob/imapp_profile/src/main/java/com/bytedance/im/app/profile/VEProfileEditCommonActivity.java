...
public class VEProfileEditCommonActivity extends Activity {
    ...
    public static void startForResult(Activity activity, String title, String initText, int limit, int requestCode) {
        Intent intent = new Intent(activity, VEProfileEditCommonActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ve_im_profile_activity_edit_group_name);
