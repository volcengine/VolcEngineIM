...
public class VELiveMemberViewHolder extends RecyclerView.ViewHolder {
    ...
    public VELiveMemberViewHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(VELiveMemberWrapper memberWrapper) {
        ...
        //名称
        nickName.setText(BIMUINameUtils.getShowNameInGroup(memberWrapper.getMember(),memberWrapper.getFullInfo()));
        String tags = "";
        ...
        //头像
        Glide.with(userHeadImg.getContext()).load(BIMUINameUtils.getPortraitUrl(memberWrapper.getMember(),memberWrapper.getFullInfo()))
                .dontAnimate()
