...
public class VELiveMemberSilentListActivity extends Activity {
    ...
    private void showOperation(VELiveMemberWrapper memberWrapper) {
        ...
        dialogInfo.add(new android.util.Pair("移出成员", (VELiveGroupDialogUtils.BottomInputDialogListener) (v, text) -> {
            BIMSimpleCallback removeSilentCallback = new BIMSimpleCallback() {
            ...
            BIMClient.getInstance().getService(BIMLiveExpandService.class).removeLiveGroupMemberSilentListString(conversationShortId, Collections.singletonList(memberWrapper.getMember().getUserIDString()), removeSilentCallback);
        }));
