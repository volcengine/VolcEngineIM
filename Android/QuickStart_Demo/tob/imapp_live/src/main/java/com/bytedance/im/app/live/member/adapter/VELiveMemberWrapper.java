...
public class VELiveMemberWrapper {
    ...
    public VELiveMemberWrapper(BIMMember member, BIMUIUser user, int type) {
    ...
    public void setFullInfo(BIMUIUser user) {
        this.user = user;
    }
