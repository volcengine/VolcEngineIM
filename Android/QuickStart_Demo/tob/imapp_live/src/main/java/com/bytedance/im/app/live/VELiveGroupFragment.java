...
public class VELiveGroupFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.ve_im_live_fragment_live_group, container, false);
    ...
    private void showPopUpWindow(View createBtn) {
        View contentView = LayoutInflater.from(getActivity()).inflate(R.layout.ve_im_live_popup_window_live_group_create_chat, null);
