    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter.setListener(new BlackListClickListener() {
            ...
            public void onPortraitClick(VEContactBlackListData data) {
                BIMUIClient.getInstance().getModuleStarter().startProfileModule(VEContactBlockListActivity.this, data.getUserFullInfo().getUid());
            }
        });
        ...
        if (dialog.getWindow() != null) {
            ...
            tvConfirm.setOnClickListener(v -> {
                if (null == et.getText() || TextUtils.isEmpty(et.getText().toString())) {
                    ...
                    BIMUIClient.getInstance().getUserExistChecker().check(Collections.singletonList(uid), new BIMResultCallback<Map<Long, Boolean>>() {
                        @Override
