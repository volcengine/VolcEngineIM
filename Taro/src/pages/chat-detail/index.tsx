  ...
  return (
    <View>
      ...
      <View
        onClick={() => {
          Taro.navigateTo({
            url: '/pages/chat-participant-list/index'
          });
        }}
      >
        群成员({conversation.getParticipantList().length})
      </View>
      ...
      <View>
        ...
        <OsSwitch
          ...
          onChange={() => {
            imInstance?.setConversationSettingInfo({
              conversation: conversation,
              mute: !conversation.isMuted
            });
          }}
        ></OsSwitch>
      </View>
      <View>
        置顶聊天
        <OsSwitch
          checked={conversation.isStickOnTop}
          onChange={() => {
            imInstance?.setConversationSettingInfo({
              conversation: conversation,
              stickOnTop: !conversation.isStickOnTop
            });
          }}
        ></OsSwitch>
      </View>
        ...
        <View>
          ...
          {isOwner && (
            <OsButton
              type="primary"
              onClick={() => {
                dissolveGroupConversation(conversation.id);
                Taro.switchTab({ url: '/pages/home/index' });
              }}
            >
              解散群组
